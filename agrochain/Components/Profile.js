...
const Profile = () => {
	...
	const ETH_to_USD = () => {
		api.get('data/price?fsym=CELO&tsyms=USD').then(({ data }) => {
			...
			<div className="row">
				<div className="col-md-12">
					<h2 className="mb-0">{farmername ? 'Farmer': 'Customer'} Wallet</h2>
						<p className="text-muted type-6 mt-0"><i className="fa fa-circle fa-fw fa-sm text-success"></i> Celo Alfajores Test Network</p>
				</div>
			</div>
			<div className="row">
					...
					<div className="card border-2x mb-3" id="basic-details-2">
						<div className="card-body">
								...
								<div className="col-md-8 text-center">
									<br />
										<h2 className="mt-1 text-dark-grey">{balance.slice(0, 5)} CELO</h2>
								</div>
							</div>
																	...
																	<div className="row mt-3">
																		<div className="col-md-6">
																			<p className="text-success type-6 my-0">
																				<i className="fab fa-celo"> </i> {ethers.utils.formatEther(item.totalPrice)}
																			</p>
																		...
																		<div className="col-md-6">
																			...
																			<p className="text-danger type-6 my-0">
																				<i className="fab fa-celo"> </i> {ethers.utils.formatEther(item.totalPrice) * (100 / 101)}
																			</p>
																		</div>
																	</div>
																</div>
																...
																<div className="card-body">
																	...
																	<div className="row mt-3">
																		<div className="col-md-6">
																			...
																			<p className="text-success type-6 my-0">
																				<i className="fab fa-celo"> </i>{ethers.utils.formatEther(item.price)}
																			</p>
																		</div>
																		<div className="col-md-6">
																			<div className="text-end float-end mt-1">
							...
							<div className="modal-content">
								<div className="modal-body">
									...
									<div className="mx-2">
										...
										<br />
										<div className="form-group">
												<h6><i className="fab fa-celo"> </i> Price (CELO) = { usd * price } USD <span className="text-danger">*</span></h6>
